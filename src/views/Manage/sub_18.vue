<template>
    <div class="sub2-container">
        ...
        <div class="sub2-T1">엑셀 다운로드 이력</div>
    </div>
    ...
    export default {
        ...
        data () {
            return {
                ...
                endDate:new Date(),
                listArray: [
                    {compName:"ATIVE 홀딩스", partName:"메일사용", name:"test계정(일반)", account:"rpabot1@ATIVE.co.kr", auth:"그룹IT권한", item:"(ATIVE홀딩스) 인력현황.xlsx",time:"2022-11-30 17:00:36"},
                    {compName:"ATIVE 홀딩스", partName:"메일사용", name:"test계정(일반)", account:"rpabot1@ATIVE.co.kr", auth:"그룹IT권한", item:"(ATIVE홀딩스) 인력현황.xlsx",time:"2022-11-30 17:00:36"},
                    {compName:"ATIVE 홀딩스", partName:"메일사용", name:"test계정(일반)", account:"rpabot1@ATIVE.co.kr", auth:"그룹IT권한", item:"(ATIVE홀딩스) 인력현황.xlsx",time:"2022-11-30 17:00:36"},
                    {compName:"ATIVE 홀딩스", partName:"메일사용", name:"test계정(일반)", account:"rpabot1@ATIVE.co.kr", auth:"그룹IT권한", item:"(ATIVE홀딩스) 인력현황.xlsx",time:"2022-11-30 17:00:36"},
                    {compName:"ATIVE 홀딩스", partName:"메일사용", name:"test계정(일반)", account:"rpabot1@ATIVE.co.kr", auth:"그룹IT권한", item:"(ATIVE홀딩스) 인력현황.xlsx",time:"2022-11-30 17:00:36"},
