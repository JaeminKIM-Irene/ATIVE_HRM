    ...
    export default {
        ...
        data () {
            return {
                ...
                pageSize: 10,
                listArray: [
                    {id:"COOT001", compName:"ATIVE 홀딩스", workName:"임원 접대성 경비 내역 취합", time:180, request: 0, gather: 0, notice: 0, na: 0, charge:"김무성", schedule:"매일 08:30", botName:"2_rpabot03", use: "Y"},
                    {id:"COOT001", compName:"ATIVE 홀딩스", workName:"임원 접대성 경비 내역 취합", time:180, request: 0, gather: 0, notice: 0, na: 0, charge:"김무성", schedule:"매일 08:30", botName:"2_rpabot03", use: "Y"},
                    {id:"COOT001", compName:"ATIVE 홀딩스", workName:"임원 접대성 경비 내역 취합", time:180, request: 0, gather: 0, notice: 0, na: 0, charge:"김무성", schedule:"매일 08:30", botName:"2_rpabot03", use: "Y"},
                    {id:"COOT001", compName:"ATIVE 홀딩스", workName:"임원 접대성 경비 내역 취합", time:180, request: 0, gather: 0, notice: 0, na: 0, charge:"김무성", schedule:"매일 08:30", botName:"2_rpabot03", use: "Y"},
                    {id:"COOT001", compName:"ATIVE 홀딩스", workName:"임원 접대성 경비 내역 취합", time:180, request: 0, gather: 0, notice: 0, na: 0, charge:"김무성", schedule:"매일 08:30", botName:"2_rpabot03", use: "Y"},
